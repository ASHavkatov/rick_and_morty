...
mixin _$HomeState {
 ...
 CharacterModel? get model; HomeStatus get status;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is HomeState&&(identical(other.model, model) || other.model == model)&&(identical(other.status, status) || other.status == status));
}
...
@useResult
$Res call({
 CharacterModel? model, HomeStatus status
});
...
class _HomeState implements HomeState {
  const _HomeState({required this.model, required this.status});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _HomeState&&(identical(other.model, model) || other.model == model)&&(identical(other.status, status) || other.status == status));
}
